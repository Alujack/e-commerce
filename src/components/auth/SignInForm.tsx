...
// Define the props for the SigninForm
interface SigninFormProps {
  onClose: () => void;
  onToggleForm: () => void;
}

const SigninForm: React.FC<SigninFormProps> = ({ onClose, onToggleForm }) => {
    ...
    <div>
      <div className="flex flex-col self-stretch items-center gap-2.5">
        <Heading
          size="14xl"
          as="h1"
          className="!text-black-900_01 tracking-[-2.00px] !font-poppins text-center"
        >
        ...
        <form onSubmit={onSubmit}>
          <div className="flex flex-col items-center justify-center w-full gap-[26px] p-[27px] sm:p-5 bg-white-A700 shadow-xs rounded-[20px]">
            ...
            <Text
              as="p"
              className="mb-1 !text-gray-600 !font-poppins text-center"
            >
