                ...
                <div className="flex flex-col self-stretch items-start mt-5 gap-2">
                  ...
                  <div className="flex sm:flex-col self-stretch items-center">
                    <div className="flex justify-center items-center w-[32%] sm:w-full p-[7px] border-gray-500_33 border border-solid bg-white-A700 rounded-[10px]">
                      <Img src="images/img_settings.svg" alt="settings_one" className="h-[23px] my-[7px]" />
                      ...
                      <Img src="images/img_settings.svg" alt="settings_three" className="h-[23px]" />
                    </div>
                    <Button
                      color="green_700"
                      size="9xl"
            ...
            <div className="flex flex-col gap-4 bg-white-A700 rounded-[10px]">
              ...
              <div className="flex flex-col gap-2.5">
                <div className="flex md:flex-col gap-[13px] flex-1">
                  <div className="w-full p-5 bg-gray-100_03 rounded-[10px]">
                    <div className="flex flex-col gap-2.5">
                      <div className="flex flex-col gap-2">
                        <Img
                          src="images/img_image.png"
                          alt="extra_bass_one"
                          className="h-[186px] object-cover rounded"
                        />
                        <div className="flex flex-col items-start gap-1.5">
                          <div className="flex self-stretch">
                            <div className="flex flex-col items-start">
                              ...
                              <Heading size="xl" as="h6" className="!text-gray-900_07 !font-manrope">
                                Sony Black Headphones
                              </Heading>
                            </div>
                          </div>
                          <Heading size="8xl" as="h4" className="!text-gray-900_07 !font-manrope">
                            $100
                          </Heading>
                        </div>
                      </div>
                      <div className="flex justify-between gap-5">
                        <div className="flex justify-center w-[26%] p-3 border-blue_gray-100_01 border border-solid bg-white-A700 rounded">
                          <Img src="images/img_cart_teal_900.svg" alt="image" className="h-[20px] w-[21px]" />
                        </div>
                        <Button
                          shape="round"
                  ...
                  <div className="w-full p-5 bg-gray-100_03 rounded-[10px]">
                    <div className="flex flex-col gap-2.5">
                      <div className="flex flex-col gap-2">
                        <Img src="images/img_image.png" alt="extra_bass" className="h-[186px] object-cover rounded" />
                        <div className="flex flex-col items-start gap-1.5">
                          <div className="flex self-stretch">
                            <div className="flex flex-col items-start">
                              <Text as="p" className="!text-blue_gray-500 !font-manrope">
                      ...
                      <div className="flex justify-between gap-5">
                        <div className="flex justify-center w-[26%] p-3 border-blue_gray-100_01 border border-solid bg-white-A700 rounded">
                          <Img src="images/img_cart_teal_900.svg" alt="image_one" className="h-[20px] w-[21px]" />
                        </div>
                        <Button
                          shape="round"
                          rightIcon={<Img src="images/img_arrowright.svg" alt="arrow_right" />}
                  ...
                  <div className="w-full p-5 bg-gray-100_03 rounded-[10px]">
                    <div className="flex flex-col gap-2.5">
                      ...
                      <div className="flex justify-between gap-5">
                        <div className="flex justify-center w-[26%] p-3 border-blue_gray-100_01 border border-solid bg-white-A700 rounded">
                          <Img src="images/img_cart_teal_900.svg" alt="image_two" className="h-[20px] w-[21px]" />
                        </div>
                        <Button
                          shape="round"
                          rightIcon={<Img src="images/img_arrowright.svg" alt="arrow_right" />}
                  ...
                  <ProductCard className="w-full p-5 bg-gray-100_03 rounded-[10px]" />
                </div>
                <div className="flex md:flex-col gap-[13px] flex-1">
                  <div className="flex flex-col justify-center w-full p-5 bg-gray-100_03 rounded-[10px]">
                    <div className="flex flex-col gap-2.5">
                      <div className="flex flex-col gap-2">
                        <Img
                          src="images/img_image.png"
                  ...
                  <div className="flex flex-col justify-center w-full p-5 bg-gray-100_03 rounded-[10px]">
                    <div className="flex flex-col gap-2.5">
                      <div className="flex flex-col gap-2">
                        <Img src="images/img_image.png" alt="image_one" className="h-[186px] object-cover rounded" />
                        <div className="flex flex-col items-start gap-1.5">
                          <div className="flex self-stretch">
                            <div className="flex flex-col items-start">
                              <Text as="p" className="!text-blue_gray-500 !font-manrope">
                      ...
                      <div className="flex justify-between gap-5">
                        <div className="flex justify-center w-[26%] p-3 border-blue_gray-100_01 border border-solid bg-white-A700 rounded">
                          <Img src="images/img_cart_teal_900.svg" alt="cart_one" className="h-[20px] w-[21px]" />
                        </div>
                        <Button
                          shape="round"
                          rightIcon={<Img src="images/img_arrowright.svg" alt="arrow_right" />}
