...
export default function MainDashboard1({
  ...
  depositFromMy = "Deposit from my Card",
  p28january2021 = "28 January 2021",
  p850 = "-$850",
  depositPaypal = "Deposit Paypal",
  p25january2021 = "25 January 2021",
  p2500 = "+$2,500",
  jemiWilson = "Jemi Wilson",
  p21january2021 = "21 January 2021",
  p5400 = "+$5,400",
  ...
  return (
    <div {...props}>
      <div className="flex w-full flex-col gap-[37px] pb-[25px] sm:pb-5">
            ...
            <div className="flex flex-col gap-7 self-stretch rounded-[25px] bg-white-A700_01 p-[25px] sm:p-5">
              ...
              <div className="mb-2.5 flex items-center gap-[27px] sm:flex-col">
                ...
                <Input
                  ...
                  placeholder={`525.50`}
                  suffix={
                    <div className="flex h-[22px] w-[26px] items-center justify-center">
                      <Img
                        src="images/img_save_white_a700_22x26.svg"
                        width={26}
                        height={22}
                        alt="save"
                  ...
                  className="gap-[35px] bg-blue_gray-50_05 text-indigo-300_05 sm:px-5"
                />
              </div>
            </div>
          </div>
