...
export const SELLER_MENU = [
    {href:"/seller/maindash", label:"Dashboard", icon:"/images/SellerDash/Dashboard.png"},
    {href:"/seller/seller-orderlist", label:"Order Lists", icon:"/images/SellerDash/Order Lists.png"},
