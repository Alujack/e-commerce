  ...
  return (
    <>
      <div className="w-full bg-white-A700">
        <div className="flex items-start bg-gray-900_02 md:flex-col">
          <Sidebar1 className="!sticky top-0 flex h-screen w-[242px] flex-col gap-[30px] overflow-auto bg-blue_gray-900_01 py-[22px] md:hidden md:p-5 sm:py-5" />
          <div className="flex flex-1 flex-col items-center gap-[30px] md:self-stretch md:p-5">
            <Topbar className="self-stretch"></Topbar>
            <div className="flex w-[95%] flex-col items-start gap-[22px] md:w-full">
              ...
              <div className="flex w-[72%] items-center justify-evenly gap-6 rounded-[10px] border border-solid border-blue_gray-800 bg-blue_gray-900_01 md:w-full md:flex-col">
                ...
                <div className="flex w-[13%] items-center justify-between gap-5 md:w-full md:p-5">
                  ...
                  <Img src="images/img_arrow_left_white_a700.svg" alt="arrowdownone" className="h-[24px] w-[23px]" />
                  <div className="h-full w-px bg-gray-500_af" />
                </div>
                <div className="flex w-[40%] gap-[23px] md:w-full md:flex-row md:p-5">
                  <div className="flex w-full items-center justify-between gap-5">
                    ...
                    <Img src="images/img_arrow_left_white_a700.svg" alt="order_type_one" className="h-[7px]" />
                    <div className="h-full w-px bg-gray-500_af" />
                  </div>
                  <div className="flex w-full items-center justify-between gap-5">
                    ...
                    <Img src="images/img_arrow_left_white_a700.svg" alt="arrowdownone" className="h-[7px]" />
                    <div className="h-full w-px bg-gray-500_af" />
                  </div>
                </div>
                <div className="mb-[23px] flex items-center gap-[7px] self-end md:mb-0 md:p-5">
