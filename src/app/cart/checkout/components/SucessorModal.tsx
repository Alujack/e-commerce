    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 ">
      ...
      <div className="bg-[#FFFFFF] rounded-lg p-6 w-[540px] h-[274px] max-w-md mx-auto relative shadow-lg">
        ...
        <div className="flex flex-col items-center">
          ...
          <Link href={`/orderhistory`} className="bg-blue-800 text-white-A700 py-2 px-4 mb-4 rounded hover:bg-blue-600" onClick={handleClose}>
            Go to Your Order
          </Link>
          <Link  href="/" className="bg-blue-800 text-white-A700 py-2 px-4 rounded hover:bg-blue-600" onClick={handleClose}>
            Go to HomePage
          </Link >
        </div>
      </div>
