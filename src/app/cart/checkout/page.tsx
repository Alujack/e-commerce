          ...
          <div className="w-full sm:p-5 rounded-[10px]">
            ...
            <div className="flex justify-between gap-3 space-x-[25px] mt-3 mb-3">
              <button
                ...
                className={`border rounded-[10px] w-full px-3 ${selectedOption === "inStorePickup"
              ...
              <button
                ...
                className={`border rounded-[10px] w-full px-3 ${selectedOption === "storeLocationPickup"
                    ? "border-blue-700 bg-blue-600 text-white-A700"
                    : "border-neutral-400 bg-slate-200 text-black"
                  }`}
              >
            ...
            <div
              ...
              className={`border rounded-[10px] w-full px-3 cursor-pointer ${selectedOption === "locateNearbyStore"
                  ? "border-blue-700 bg-blue-600 text-white-A700"
                  : "border-neutral-400 bg-slate-200 text-black"
                }`}
            >
