...
export default function NotFound(){
    ...
    return (
         <div className="flex h-[1070px] items-center justify-center bg-blue-A200_08  px-14 py-[167px] md:h-auto md:p-5">
            <div className="flex w-[47%] md:w-full">
              <Slider
                autoPlay
                  ...
                  < React.Fragment key={Math.random()}>
                    <div className="mx-2.5 flex w-full flex-col items-center justify-center gap-[101px] rounded-[24px] border border-solid border-gray-400_05 bg-white-A700_01 px-14 py-[102px] md:gap-[75px] md:p-5 sm:gap-[50px]">
                      ...
                      <div className="flex w-[81%] flex-col gap-8 md:w-full">
                        ...
                        <Button className="w-full rounded-lg font-bold tracking-[-0.07px] sm:px-5">
                          Back to Dashboard
                        </Button>
                      </div>
                    </div>
